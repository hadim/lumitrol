            ...
            while (!Thread.interrupted()) {
                try {
                    ...
                    imageExecutor.submit {
                        currentFrame?.let { currentFrame -> imageConsumer(currentFrame) }
                    }
...
//
//            currentFrame = BitmapFactory.decodeByteArray(
//                receivedPacket.data, imageOffset,
//                receivedPacket.length - imageOffset
//            )
